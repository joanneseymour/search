...
//    static ArrayList<Edge> edgesToSort = new ArrayList<Edge>();
    ...
    public static void displayFrontierExplored(TNode tNodeBeingChecked, Stack<TNode> lifoFrontier, ArrayList<TNode> explored){
        System.out.println(""); 
    ...
    public static void adjsToFrontier(TNode tNodeBeingChecked){
        ...
        for (int i = 0; i < adjNodes.size(); i++){
            ...
            // if adjNode is not in explored or lifoFrontier
            if (!explored.contains(adjNode) && !lifoFrontier.contains(adjNode)){
                System.out.println(adjNode.place + adjNode.id + " is not in explored or lifoFrontier, adding to lifoFrontier");
